# clic3d.tn — parcours client et maker
...
(`noindex` + `robots.txt`). Les conditions générales et les pièces des dossiers de paiement
ne figurent pas ici : elles restent dans le dépôt privé.
